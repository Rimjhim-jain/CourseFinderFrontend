...
import { addLecture, deleteCourse, deleteLecture } from '../../../redux/actions/admin.js';
    ...
    <Tr>
      ...
      <Td isNumeric>
        <HStack justifyContent ={"flex-end"}>
          <Button onClick={()=>courseDetailsHandler(item._id, item.title)} variant={"outline"} color={"purple.500"} isLoading={loading}>View Lectures</Button>
